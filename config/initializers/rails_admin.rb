# RailsAdmin config file. Generated on November 07, 2013 21:39
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Gift Launcher', 'Admin']
  ...
  # config.excluded_models = ['Event', 'Facebook', 'Gift', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'Facebook', 'Gift', 'User']
  config.included_models = ['Event', 'Gift', 'User']
  ...
  # config.model 'Facebook' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your facebook.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your gift.rb model definition
  ...
  #     configure :facebook, :has_one_association 
